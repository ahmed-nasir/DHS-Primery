        ...
        <div class="row mt-30">
            ...
            <div class="col-md-5 col-sm-5 col-xs-12">
                <div class="our-mission-box-img">
                  <img src="{{asset('assets/frontend/images/about-page.jpg')}}" alt="img">
                </div>
            </div>
...
<div id="our-partner">
  <div class="container-fluid">
    <div id="partner_slider" class="owl-carousel">
      <div class="item"><img src="{{asset('assets/frontend/images/partner-1.png')}}" alt="Our Partner"></div>
      <div class="item"><img src="{{asset('assets/frontend/images/partner-2.png')}}" alt="Our Partner"></div>
      <div class="item"><img src="{{asset('assets/frontend/images/partner-3.png')}}" alt="Our Partner"></div>
      <div class="item"><img src="{{asset('assets/frontend/images/partner-4.png')}}" alt="Our Partner"></div>
      <div class="item"><img src="{{asset('assets/frontend/images/partner-5.png')}}" alt="Our Partner"></div>
      <div class="item"><img src="{{asset('assets/frontend/images/partner-1.png')}}" alt="Our Partner"></div>
      <div class="item"><img src="{{asset('assets/frontend/images/partner-2.png')}}" alt="Our Partner"></div>
      <div class="item"><img src="{{asset('assets/frontend/images/partner-3.png')}}" alt="Our Partner"></div>
      <div class="item"><img src="{{asset('assets/frontend/images/partner-4.png')}}" alt="Our Partner"></div>
