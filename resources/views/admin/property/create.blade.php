                    ...
                    <form action="{{ route('admin.property.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                             ...
                             @if ($errors->has('property_titel'))
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $errors->first('property_titel') }}</strong>
                                </span>
                            @endif
                        </div>
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                        ...
                        <input type="checkbox" id="property_publication_status" name="property_publication_status" class="filled-in">
